...
max_favs = 0 # Don't delete a tweet if it has more than this number of favorites
max_rts = 0 # Don't delete a tweet if it has more than this number of retweets
days_to_keep = 0 # How many days tweets to keep?
