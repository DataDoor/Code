...
GO
        ...
        SELECT  [TABLE_SCHEMA]      = LOWER(S.[name]),
                ...
                [Indexed Columns]	= ISNULL(REPLACE(REPLACE(REPLACE((
					                    ...
					                    FROM [sys].[index_columns] AS sic
						                    JOIN [sys].[columns] AS c ON c.column_id = sic.column_id AND c.[object_id] = sic.[object_id]
    ...
    SELECT  DISTINCT
            ...
            [< Referenced Column]   = CU.COLUMN_NAME,
    ...
    FROM [sys].[foreign_keys]                       AS FK
        ...
        JOIN INFORMATION_SCHEMA.KEY_COLUMN_USAGE    AS CU ON CU.TABLE_NAME = DEST.[Name] AND CU.TABLE_SCHEMA = SCH.[Name]
