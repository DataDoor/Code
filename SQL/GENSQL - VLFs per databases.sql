 ...
 Anywhere where there are VLF over 300 need to be looked at, look at the size of the log and shrink if to large, the look at the size of the increments which 
 the log grows in, if its to small then it needs increasing */
