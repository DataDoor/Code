/*TRACES - This SQL can be used to read the default trace or any trace into a results format in SSMS


Syntax to query currently executing traces:


/*Find the trace filename details for from the below dmv*/
SELECT path FROM sys.traces

/*Then place the filename/path into the first section*/
SELECT *
FROM fn_trace_gettable ( [Filename] ,default )

/*For example this is for the default trace*/
SELECT *
FROM fn_trace_gettable ( 'C:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\LOG\log_2315.trc' ,default )
...
Trace events - To show was data can be gathered and derived from the Traces
Default trace scripts -(
READ ALL DATA
DATA FILE GROWTH
LOG FILE GROWTH
ERRORS AND WARNINGS
EXECUTION PLAN HIGHLIGHTED PROBLEMS -  Sort, hash, Join predicate errors
OBJECT EVENTS - Object Altered, Object Created, Object Deleted
SECURITY AUDIT EVENTS - Login, created, deleted, Login failed
SQL SERVER START AND STOPS)
*/
...
/*EXECUTION PLAN HIGHLIGHTED PROBLEMS
