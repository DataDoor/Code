/*WAIT STATISTICS - This Scripts show various aspect of wait statistics

/*Use this to clear waitstats data without restarting the sql instance*/
...
Wait time compared to total runtime
Wait Stats by percentage
Time delay wait stats
...
SELECT 
	CAST (100.0 * SUM(signal_wait_time_ms) / Sum (wait_Time_ms) AS NUMERIC(20,2)) AS [CpuWaits%],
	CAST (100.0 * SUM(wait_time_ms - Signal_wait_time_ms) / SUM(wait_time_ms) AS NUMERIC(20,2)) AS [CPUResource%]
