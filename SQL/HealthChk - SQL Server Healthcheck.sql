/*Health Check for SQL Server 2012 - **note, not all of these scripts will on versions below 2012*/

/*Compatability is marked by each one*/
...
/*2005 (limited), 2008 (limited), 2012
...
/*2012
 ...
 Knowing this location information is important for troubleshooting purposes
*/
...
/*Get configuration values for instance 2005+
...
/* Get information about TCP Listener for SQL Server 2012*/
...
/*SQL Server Registry information 2008R2+
...
/* Get information on location, time and size of any memory dumps from SQL Server
 ...
 If this does return a result this need investigation
*/
...
/*File Names and Paths for Tempdb and all user databases in instance 2005+ 
...
and compatibility level for all databases on instance 2005+
...
/*Get total buffer usage by database for current instance 2005+
...
/*
 Get CPU utilization by database 2005+
...
/*Isolate top waits for server instance since last restart or statistics clear 2005+
...
/*
Signal Waits for instance - Signal Waits above 15-20% is usually a sign of CPU pressure
*/
...
/* Get Average Task Counts (run multiple times) 2005+
...
/*Good basic information about OS memory amounts and state 2012+
...
Engine. This information is more reliable than what is displayed in Windows Task Manager.
...
/*
Page Life Expectancy (PLE) value for default instance 2005+
...
/*
Memory Grants Outstanding value for default instance 2005+
